...
const patterns = [
    ...
    {
        name: 'อีเมล',
        // Keywords + email-like: อีเมล xxx at/แอท yyy .com
        regex: /(?:email|อีเมล|อีเมลล์|เมล|e-mail|mail)[\s:=]*[a-zA-Z0-9._%+\-]+[\s]*(?:@|at|แอท)[\s]*[a-zA-Z0-9.\-]+/i,
    },
    {
        name: 'อีเมล',
        // "แอท" used instead of @: xxx แอท gmail จุด com
    ...
    {
        name: 'LINE ID',
        // QR line, เพิ่มเพื่อน line, แอดมา
    ...
    {
        name: 'เลขบัตรประชาชน',
        // 13 digits with any separators: x-xxxx-xxxxx-xx-x
        regex: new RegExp(`\\b\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d${S}\\d\\b`),
    },
    {
        name: 'เลขบัตรประชาชน',
        // Keywords: บัตรประชาชน, national id, citizen id
    ...
    {
        name: 'ที่อยู่',
        // Thai postal code (5 digits starting with 1-9)
        regex: /\b[1-9]\d{4}\b/,
    },
    {
        name: 'ที่อยู่',
        // จังหวัดชื่อเต็ม (ครอบคลุมทุกจังหวัดที่ใช้บ่อย)
    ...
    {
        name: 'ที่อยู่',
        // Street / Road / Soi / Building + number
    ...
    {
        name: 'ลิงก์/URL',
        // http(s) links, common profile/contact URLs
        regex: /https?:\/\/[^\s]{5,}/i,
    },
    {
        name: 'ลิงก์/URL',
