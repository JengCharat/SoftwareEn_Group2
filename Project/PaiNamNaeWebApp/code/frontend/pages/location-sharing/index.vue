<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <!-- No token -->
    <div v-else-if="!token" class="p-8 text-center max-w-md mx-auto mt-10">
      <div class="text-6xl mb-4">❓</div>
      <h2 class="text-xl font-bold text-gray-700">ลิงก์ไม่ถูกต้อง</h2>
      <p class="text-gray-500 mt-2 text-sm">ไม่พบ token ในลิงก์นี้</p>
    </div>
