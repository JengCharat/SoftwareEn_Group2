...
*** Test Cases ***
CHAT07 - Passenger Can Open Chat In Confirmed Booking
    [Documentation]    Passenger เปิดแชทใน Booking ที่ยืนยันแล้ว → เข้าได้ปกติ ไม่ได้รับ 404
    Login As Passenger
    Sleep    2s
    Go To My Trips Page
    Sleep    2s
...
ื
CHAT08 - Passenger Opens Chat And Sees Only Role And Profile Picture
...
CHAT09 - Passenger Sends Message And Driver Receives Within 5 Seconds
...
CHAT10 - Passenger Sends Message And It Appears Immediately
